    ...
    <div class="card-header p-0 pb-2">
        <div class="toolbar row ">
            <div class="col-md-6 col-sm-6 col-6">
                <h5 class="h5 text-uppercase">List Konten Kebijakan Mutu & Maklumat Setting</h5>
            </div>
        </div>
    </div>

    <table class="table datatables table-bordered table-hover table-data" id="table-quality-policy">
        <thead>
        ...
        <tbody>
                    ...
                    <td class="w-5p">
                        ...
                        <div class="dropdown-menu dropdown-menu-right">
                            <label class="dropdown-item pointer"
                                onclick="activityDetail('quality-policy','edit',{{ $detail->id }})"><span
            ...
            @empty
                <tr colspan="5">Tidak terdapat data konten Kebijakan Mutu & Maklumat Perusahaan</tr>
            @endforelse
        </tbody>
    </table>
