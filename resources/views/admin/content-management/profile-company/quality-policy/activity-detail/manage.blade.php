<div class="card-body pt-2" id="manage-quality-policy">
    <form action="javascript:void(0)" id="form-master-quality-policy" enctype="multipart/form-data">
        @csrf
            ...
            <div class="col-md-8">
                ...
                <div class="form-group">
                    <input type="text" id="name" name="name"
                        class="form-control form-control-sm bg-transparent" readonly value="{{ $master->name }}">
                </div>
            </div>
            <div class="col-md-12">
                ...
                <div class="card-header">
                    <div class="toolbar row ">
                        <div class="col-md-8 col-sm-8 col-8">
                            <h5 class="h5 text-uppercase">List Konten Kebijakan Mutu & Maklumat Perusahaan</h5>
                        </div>
                    </div>
                </div>
