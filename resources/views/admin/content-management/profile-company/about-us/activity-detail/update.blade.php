    ...
    <div class="card-header p-0 pb-2">
        <div class="toolbar row ">
            <div class="col-md-6 col-sm-6 col-6">
                <h5 class="h5 text-uppercase">List Konten About Us Setting</h5>
            </div>
        </div>
    </div>

    <table class="table datatables table-bordered table-hover table-data" id="table-about-us">
        <thead>
        ...
        <tbody>
                    ...
                    <td class="w-5p">
                        ...
                        <div class="dropdown-menu dropdown-menu-right">
                            <label class="dropdown-item pointer"
                                onclick="activityDetail('about-us','edit',{{ $detail->id }})"><span
            ...
            @empty
                <tr colspan="5">Tidak terdapat data konten Tentang Perusahaan</tr>
            @endforelse
        </tbody>
    </table>
