<div class="card-body pt-2" id="manage-about-us">
    <form action="javascript:void(0)" id="form-master-about-us" enctype="multipart/form-data">
        @csrf
                ...
                <div class="card-header">
                    <div class="toolbar row ">
                        <div class="col-md-8 col-sm-8 col-8">
                            <h5 class="h5 text-uppercase">List Konten Tentang Perusahaan</h5>
                        </div>
                    </div>
                </div>
