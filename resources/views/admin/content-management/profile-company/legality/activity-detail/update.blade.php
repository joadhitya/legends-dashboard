        ...
        <div class="toolbar row ">
            ...
            <div class="col-md-6 col-sm-6 col-6">
                {{-- <button type="button" class="btn btn-sm btn-primary mr-1 float-right text-uppercase"
                    onclick="activityDetail('legality','add')"><i class="fe fe-plus"></i> Tambah Data</button> --}}
            </div>
        </div>
    </div>

    <table class="table datatables table-bordered table-hover table-data" id="table-legality">
        <thead>
                    ...
                    <td class="w-5p">
                        ...
                        <div class="dropdown-menu dropdown-menu-right">
                            {{-- <label class="dropdown-item pointer"
                                onclick="activityDetail('legality','view',{{ $detail->id }})"><span
                                    class="mr-2 fe fe-eye"></span>Lihat</label> --}}
                            <label class="dropdown-item pointer"
                                onclick="activityDetail('legality','edit',{{ $detail->id }})"><span
