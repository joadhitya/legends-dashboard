<form action="javascript:void(0)" id="form-organization" enctype="multipart/form-data">
    @csrf
    ...
    <div class="row">
        ...
        <div class="col-md-2">
            ...
            <div class="form-group">
                ...
                @if ($data->image)
                    <a target="_blank" href="{{ url('content/organization/' . $data->image) }}" class="">Lihat gambar konten</a>
                @endif
            </div>
        </div>
        <div class="col-md-12">
    ...
    <div class="row" id="button-action-add-on">
        ...
        <div class="col-md-6">
            @if (!$data)
                <button type="submit" id="add-organization"
            ...
            @else
                <button type="submit" id="edit-organization"
