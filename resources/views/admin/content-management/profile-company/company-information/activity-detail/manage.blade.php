<div class="card-body pt-2" id="manage-company-information">
    <form action="javascript:void(0)" id="form-master-company-information" enctype="multipart/form-data">
        @csrf
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                ...
                <div class="form-group">
                    <input readonly type="text" id="description" name="description" value="{{ $master->description }}"
                ...
                <div class="card-header">
                    <div class="toolbar row ">
                        <div class="col-md-8 col-sm-8 col-8">
                            <h5 class="h5 text-uppercase">List Konten Profile Perusahaan</h5>
                        </div>
                    </div>
                </div>
                <div class="card-body" id="">
                    <table class="table datatables table-bordered table-hover table-data" id="table-company-information">
                        <thead>
                            <tr>
                                <th class="w-5p">No</th>
                        ...
                        <tbody>
                            @foreach ($data as $key => $item)
                                <tr>
                                    ...
                                    <td class="w-5p"><div class="btn-group btn-group-sm" role="group">
                                        <button type="button" class="btn p5x btn-sm btn-outline-primary" onclick="openModal('category-field','edit', 1)"><span class="fe fe-info"></span></button>
                                    </div></td>
                                </tr>
                            @endforeach
                        </tbody>
