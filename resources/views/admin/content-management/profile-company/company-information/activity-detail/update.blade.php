<div class="card-body pt-2">
    <div class="card-header p-0 pb-2">
        <div class="toolbar row ">
            <div class="col-md-6 col-sm-6 col-6">
                <h5 class="h5 text-uppercase">List Konten Profile Setting</h5>
            </div>
        </div>
    </div>
    ...
    <table class="table datatables table-bordered table-hover table-data" id="table-company-information">
        ...
        <tbody>
            @forelse ($data as $detail)
                <tr>
                    ...
                    <td class="w-10p {{ $detail->is_active == 'yes' ? 'text-success' : 'text-danger' }}">
                        {{ $detail->is_active == 'yes' ? 'Aktif' : 'Tidak Aktif' }}
                    </td>
                    <td class="w-5p">
                        ...
                        <div class="dropdown-menu dropdown-menu-right">
                            <label class="dropdown-item pointer"
                                onclick="activityDetail('company-information','edit',{{ $detail->id }})"><span
            ...
            @empty
                <tr colspan="5">Tidak terdapat data konten Profile Perusahaan</tr>
            @endforelse
        </tbody>
    </table>
