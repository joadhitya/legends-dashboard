<form action="javascript:void(0)" id="form-complaint-compensation" enctype="multipart/form-data">
    @csrf
        ...
        <div class="col-md-4">
            ...
            <div class="input-group input-group-sm">
                <div class="input-group-prepend">
                    <span class="input-group-text">complaint-compensation-</span>
                </div>

                <select class="form-control" id="group_code" name="group_code">
                    <option value="">--Pilih Kategori Konten--</option>
                    @foreach ($contentCode as $cc)
                        <option value="{{ $cc->group_code }}">{{ $cc->group_code }}</option>
                    @endforeach
                </select>
    ...
    <div class="row" id="button-action-add-on">
        ...
        <div class="col-md-6">
            @if (!$data)
                <button type="submit" id="add-complaint-compensation"
            ...
            @else
                <button type="submit" id="edit-complaint-compensation"
