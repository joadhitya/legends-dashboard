    ...
    <div class="card-header p-0 pb-2">
        <div class="toolbar row ">
            <div class="col-md-6 col-sm-6 col-6">
                <h5 class="h5 text-uppercase">List Konten data keluhan, banding & ganti rugi Setting</h5>
            </div>
            <div class="col-md-6 col-sm-6 col-6">
                <button type="button" class="btn btn-sm btn-primary mr-1 float-right text-uppercase"
                    onclick="activityDetail('complaint-compensation','add')"><i class="fe fe-plus"></i> Tambah Data</button>
            </div>
        </div>
    </div>

    <table class="table datatables table-bordered table-hover table-data" id="table-complaint-compensation">
        <thead>
        ...
        <tbody>
                    ...
                    <td class="w-5p">
                        ...
                        <div class="dropdown-menu dropdown-menu-right">
                            <label class="dropdown-item pointer"
                                onclick="activityDetail('complaint-compensation','view',{{ $detail->id }})"><span
                                    class="mr-2 fe fe-eye"></span>Lihat</label>
                            <label class="dropdown-item pointer"
                                onclick="activityDetail('complaint-compensation','edit',{{ $detail->id }})"><span
            ...
            @empty
                <tr colspan="5">Tidak terdapat data konten data keluhan, banding & ganti rugi Perusahaan</tr>
            @endforelse
        </tbody>
    </table>
