<div class="card-body pt-2" id="manage-standart-services">
    <form action="javascript:void(0)" id="form-master-standart-services" enctype="multipart/form-data">
        @csrf
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                ...
                <div class="form-group">
                    <input type="text" id="description" readonly name="description"
                        value="{{ $master->description }}" class="form-control form-control-sm bg-transparent">
                </div>
            </div>
        </div>
        <hr>
                ...
                <div class="card-header">
                    <div class="toolbar row ">
                        <div class="col-md-8 col-sm-8 col-8">
                            <h5 class="h5 text-uppercase">List Konten Standar Pelayanan & Biaya Perusahaan</h5>
                        </div>
                    </div>
                </div>
