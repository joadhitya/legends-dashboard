<div class="card-body pt-2" id="manage-competence-test">
    <form action="javascript:void(0)" id="form-master-competence-test" enctype="multipart/form-data">
        @csrf
                ...
                <div class="card-header">
                    <div class="toolbar row ">
                        <div class="col-md-8 col-sm-8 col-8">
                            <h5 class="h5 text-uppercase">List Konten Uji Kompetensi Perusahaan</h5>
                        </div>
                    </div>
                </div>
