<form action="javascript:void(0)" id="form-competence-test" enctype="multipart/form-data">
    @csrf
    ...
    <div class="row">
        <div class="col-md-4">
            ...
            <div class="form-group">
                <input type="text" id="code" name="code" class="form-control form-control-sm bg-transparent"
        ...
        <div class="col-md-2">
            <label>Gambar: </label>
            <div class="form-group">
                <input type="file" id="image" name="image" class="form-control form-control-sm bg-transparent">
            </div>
        </div>
        <div class="col-md-12">
    ...
    <div class="row" id="button-action-add-on">
        ...
        <div class="col-md-6">
            @if (!$data)
                <button type="submit" id="add-competence-test"
            ...
            @else
                <button type="submit" id="edit-competence-test"
