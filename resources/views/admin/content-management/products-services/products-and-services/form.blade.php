<form action="javascript:void(0)" id="form-products-and-services" enctype="multipart/form-data">
    @csrf
    ...
    <div class="row" id="button-action-add-on">
        ...
        <div class="col-md-6">
            @if (!$data)
                <button type="submit" id="add-products-and-services"
            ...
            @else
                <button type="submit" id="edit-products-and-services"
