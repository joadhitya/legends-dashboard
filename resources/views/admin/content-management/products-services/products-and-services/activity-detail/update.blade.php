    ...
    <div class="card-header p-0 pb-2">
        <div class="toolbar row ">
            <div class="col-md-6 col-sm-6 col-6">
                <h5 class="h5 text-uppercase">List Konten Produk dan Layanan Setting</h5>
            </div>
        </div>
    </div>

    <table class="table datatables table-bordered table-hover table-data" id="table-products-and-services">
        <thead>
        ...
        <tbody>
                    ...
                    <td class="w-5p">
                        ...
                        <div class="dropdown-menu dropdown-menu-right">
                            <label class="dropdown-item pointer"
                                onclick="activityDetail('products-and-services','edit',{{ $detail->id }})"><span
            ...
            @empty
                <tr colspan="5">Tidak terdapat data konten Produk dan Layanan Perusahaan</tr>
            @endforelse
        </tbody>
    </table>
