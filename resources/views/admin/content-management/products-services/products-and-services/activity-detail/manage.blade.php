<div class="card-body pt-2" id="manage-products-and-services">
    <form action="javascript:void(0)" id="form-master-products-and-services" enctype="multipart/form-data">
        @csrf
                ...
                <div class="card-header">
                    <div class="toolbar row ">
                        <div class="col-md-8 col-sm-8 col-8">
                            <h5 class="h5 text-uppercase">List Konten Produk dan Layanan Perusahaan</h5>
                        </div>
                    </div>
                </div>
