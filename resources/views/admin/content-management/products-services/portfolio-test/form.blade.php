<form action="javascript:void(0)" id="form-portfolio-test" enctype="multipart/form-data">
    @csrf
    ...
    <div class="row" id="button-action-add-on">
        ...
        <div class="col-md-6">
            @if (!$data)
                <button type="submit" id="add-portfolio-test"
            ...
            @else
                <button type="submit" id="edit-portfolio-test"
